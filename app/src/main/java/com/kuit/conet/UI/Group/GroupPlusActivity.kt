...
class GroupPlusActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val option: Int by lazy { intent.getIntExtra("option", 0) }     // 0: 그룹 추가하기 , 1: 그룹 수정하기
...
//                    TODO : 이름과 사진에 대한 정보를 서버에 보내기, 사진을 파일화 하기
                    when (option) {
                        1 -> {
                            val jsonString =
                                "{\"teamId\" : ${groupId}, \"teamName\" : \"${binding.groupNameTf.text}\"}"
                            val jsonList =
                            ...
                            if (::body.isInitialized == false) {
                                ...
                                RetrofitClient.instance.updateGroup(
                                    ...
                                    override fun onResponse(
                                        ...
                                        } else Log.d(NETWORK, "GroupPlusActivity - Retrofit updateGroup() 실행결과 - 안좋음")
                                    }
                                    ...
                                    override fun onFailure(
                                        ...
                                        Log.d(NETWORK, "GroupPlusActivity - Retrofit updateGroup() 실행결과 - 실패\n" + "t : $t")
                                    }
                                })
                            }
                        }
